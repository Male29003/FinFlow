...
namespace WebAPIs.Controllers.v1
{
    ...
    public class GiaoDichController : BaseApiController
    {
        ...
        [HttpGet]
        [Authorize]
        public async Task<ActionResult<PagedResult<GiaoDichDTO>>> GetAll([FromQuery] int page = 1, [FromQuery] int size = 10, [FromQuery] string? keyword = null , [FromQuery] int? maTaiKhoan=null, [FromQuery] string? phanLoai=null)
        {
        ...
        {
            return HandleResponse(await Mediator.Send(new GiaoDichFeatures.Delete { Id = id }));
        }
        /// <summary>
